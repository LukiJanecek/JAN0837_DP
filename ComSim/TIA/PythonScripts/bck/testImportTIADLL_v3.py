...
# Usage: python testImportTIADLL_v2.py --dir "C:\Program Files\Siemens\Automation\Portal V19\PublicAPI\V19"
...
def main():
    ...
    # Ensure native DLL search path (Python 3.8+)
    ...
    try:
        ...
        # print assemblies found in the directory (helpful debug)
        ...
        traceback.print_exc(file=sys.stderr)
        # dump candidate files to help debug
        try:
            dlls = sorted(dll_dir.glob("*.dll"))
